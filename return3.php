...
function process($arrKlonWord,$arrKlonPayang,$arrKlonPhonemes,$arrKlonTone,$arrWak,$arrKlonPhonemesAndTone){
	//$_SESSION['a'] = "aa";
...
function getData(){
	...
	for ($i=0; $i<count($arrWak)-1 ;) {
		...
		//$jsonWak[$i] = readTxt("poem4wak".$index.".txt");
		...
		//$jsonWak[$i] = readTxt("poem22wak".$index.".txt");
	...
	//print_r ($jsonWak);
	process($arrKlonWord,$arrKlonPayang,$arrKlonPhonemes,$arrKlonTone,$arrWak,$arrKlonPhonemesAndTone);
}
